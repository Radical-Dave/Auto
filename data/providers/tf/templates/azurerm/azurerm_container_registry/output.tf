...
output "container_registry_admin_username" {
  ...
  value       = var.acr_admin_enabled == true ? azurerm_container_registry.this.admin_username : null
}
output "container_registry_admin_password" {
  description = "The Username associated with the Container Registry Admin account - if the admin account is enabled."
  value       = var.acr_admin_enabled == true ? azurerm_container_registry.this.admin_password : null
  sensitive   = true
}
...
output "container_registry_scope_map_id" {
  ...
  value       = var.scope_map != null ? [for k in azurerm_container_registry_scope_map.acr : k.id] : null
}
output "container_registry_token_id" {
  description = "The ID of the Container Registry token"
  value       = var.scope_map != null ? [for k in azurerm_container_registry_token.acr : k.id] : null
}
output "container_registry_webhook_id" {
  description = "The ID of the Container Registry Webhook"
  value       = var.container_registry_webhooks != null ? [for k in azurerm_container_registry_webhook.acr : k.id] : null
}
