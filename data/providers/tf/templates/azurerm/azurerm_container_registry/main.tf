...
locals {
  ...
  resource_group_name = length(var.acr_resource_group_name != null ? var.acr_resource_group_name : "") > 0 ? var.acr_resource_group_name : var.resource_group_name
}
resource "azurerm_container_registry" "this" {
  ...
  admin_enabled = var.acr_admin_enabled #var.container_registry_config.admin_enabled
  public_network_access_enabled = var.acr_public_network_access_enabled #var.container_registry_config.public_network_access_enabled
  quarantine_policy_enabled = var.acr_quarantine_policy_enabled #var.container_registry_config.quarantine_policy_enabled
  zone_redundancy_enabled = var.acr_zone_redundancy_enabled #var.container_registry_config.zone_redundancy_enabled
