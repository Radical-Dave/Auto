...
#   resource_group_name=local.resource_group_name
# }
module "azurerm_app_service_cname_record" {
...
module "azurerm_app_service_txt_record" {
...
resource "time_sleep" "wait_15_seconds" {
  create_duration = "15s"
  depends_on      = [module.azurerm_app_service_txt_record]
}
module "azurerm_app_service_custom_hostname_binding" {
  depends_on          = [module.azurerm_windows_web_app, module.azurerm_app_service_txt_record]
