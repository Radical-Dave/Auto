...
variable "app_settings_api" {
  description = "The app_settings_api of the App"
  type        = map(string)
  default     = {}
}
variable "app_settings_api_core" {
  description = "The app_settings_api_core of the App"
  type        = map(string)
  default     = {}
}
variable "app_sp" {
...
variable "client_affinity_enabled" {
  description = "The client_affinity_enabled of the AppService"
  type        = bool
  default     = false
}
variable "client_cert_enabled" {
  description = "The client_cert_enabled of the AppService"
  type        = bool
  default     = false
}
variable "client_cert_mode" {
  description = "The client_cert_mode of the AppService [Required,Optional,OptionalInteractiveUser]"
  type        = string
  default     = null
}
...
variable "docker_image_tag" {
  description = "The docker_image_tag of the web app [default latest]"
  type        = string
  default     = "latest"
}
...
variable "env_name" {
  description = "The env_name of app of the resource group"
  type        = string
  default     = null
}
...
variable "host_root" {
  description = "The host_root of the AppService Plan"
  type        = string
  default     = null
}
variable "https_only" {
