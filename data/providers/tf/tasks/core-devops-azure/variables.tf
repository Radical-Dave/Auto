variable "service_principal_names" {
  description = "The service_principal_names of the resource group"
  type        = string
  default     = null
}
...
variable "AZDO_URL" {
  description = "The AZDO_URL of the resource group"
  type        = string
  default     = null
}
variable "AZDO_PAT" {
  description = "The AZDO_PAT of the azuredevops_project"
  type        = string
}
