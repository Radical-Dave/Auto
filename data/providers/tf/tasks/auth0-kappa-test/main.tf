...
#   source="../../templates/auth0-kappa/auth0_organization"
...
module "app_auth0_connection" {
  source = "../../templates/auth0-kappa/auth0_connection"
...
module "app_auth0_client" {
  source               = "../../templates/auth0-kappa/auth0_client"
...
module "app_auth0_resource_server" {
  source                                          = "../../templates/auth0-kappa/auth0_resource_server"
...
module "app_auth0_resource_server_client_grant" {
  source    = "../../templates/auth0-kappa/auth0_client_grant"
